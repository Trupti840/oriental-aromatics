       ...
       <div className="w-full pl-0 pr-[20px] md:pr-[40px] grid md:grid-cols-4 gap-8">
         ...
         <div>
           ...
           <p className="text-gray-600 text-sm leading-relaxed mb-4">
             Premium fragrances crafted to elevate your identity and leave a lasting impression.
           </p>
         ...
         {/* Quick Links */}
         <div>
           <h4 className="text-base font-semibold mb-3 text-green-700">Quick Links</h4>
           <ul className="space-y-2 text-gray-600 text-sm">
             ...
             <li><Link href="/#explore-section" className="hover:text-green-700 transition-colors">Products</Link></li>
         ...
         {/* Products */}
         <div>
           <h4 className="text-base font-semibold mb-3 text-green-700">Our Products</h4>
           <ul className="space-y-2 text-gray-600 text-sm">
             <li><Link href="#" className="hover:text-green-700 transition-colors">Fine Fragrances</Link></li>
             <li><Link href="#" className="hover:text-green-700 transition-colors">Air Care</Link></li>
             <li><Link href="#" className="hover:text-green-700 transition-colors">Personal Care</Link></li>
             <li><Link href="#" className="hover:text-green-700 transition-colors">Home Care</Link></li>
           </ul>
         </div>
 
         {/* Contact */}
         <div>
           <h4 className="text-base font-semibold mb-3 text-green-700">Contact</h4>
 
           <div className="space-y-3 text-gray-600 text-sm">
             <div className="flex items-start space-x-2 transition-colors">
               <MapPin className="w-4 h-4 mt-1 flex-shrink-0" />
               <span className="hover:text-green-700">381/A NARROTTAM WADI, ROOM N: 14-A, 1ST FLOOR KALBADEVI ROAD, MUMBAI-400002, MAHARASHTRA, CODE: 27</span>
             </div>
             ...
             <div className="flex items-center space-x-2 transition-colors">
               ...
               <span className="hover:text-green-700">sgfragrance@hotmail.com</span>
             </div>
           </div>
         </div>
       </div>
